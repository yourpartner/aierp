...
-- 财务菜单
('finance', 'voucher.new', '{"ja":"仕訳作成","zh":"新建仕訳","en":"New Journal Entry"}', '/voucher/new', ARRAY['voucher:create'], 1),
('finance', 'vouchers.list', '{"ja":"会計伝票一覧","zh":"会计凭证列表","en":"Vouchers"}', '/vouchers', ARRAY['voucher:read'], 2),
('finance', 'accounts.list', '{"ja":"勘定科目一覧","zh":"科目列表","en":"Chart of Accounts"}', '/accounts', ARRAY['account:read'], 3),
('finance', 'account.ledger', '{"ja":"勘定明細一覧","zh":"科目明细账","en":"Account Ledger"}', '/account-ledger', ARRAY['voucher:read'], 4),
('finance', 'account.balance', '{"ja":"勘定残高","zh":"科目余额表","en":"Account Balance"}', '/account-balance', ARRAY['voucher:read'], 5),
...
('finance', 'op.bankPayment', '{"ja":"銀行出金配分","zh":"银行出金配分","en":"Bank Payment Allocation"}', '/operations/bank-payment', ARRAY['op:bank-payment'], 8),
('finance', 'op.fbPayment', '{"ja":"自動支払","zh":"自动支付","en":"Auto Payment"}', '/fb-payment', ARRAY['op:bank-payment'], 9),
('finance', 'fin.reports', '{"ja":"財務諸表","zh":"财务报表","en":"Financial Statements"}', '/financial/statements', ARRAY['report:financial'], 10),
('finance', 'fin.designer', '{"ja":"財務諸表構成","zh":"报表设计器","en":"Statement Designer"}', '/financial/nodes', ARRAY['report:financial'], 11),
('finance', 'rcpt.planner', '{"ja":"入金計画","zh":"收款计划","en":"Receipt Planner"}', NULL, ARRAY['op:bank-collect'], 12),
('finance', 'moneytree.transactions', '{"ja":"銀行明細","zh":"银行明细","en":"Bank Transactions"}', '/moneytree/transactions', ARRAY['voucher:read'], 13),
...
('finance', 'fin.consumptionTax', '{"ja":"消費税申告書","zh":"消费税申报表","en":"Consumption Tax Return"}', '/financial/consumption-tax', ARRAY['report:financial'], 17),
('finance', 'fin.cashLedger', '{"ja":"現金出納帳","zh":"现金出纳账","en":"Cash Ledger"}', '/cash/ledger', ARRAY['voucher:read'], 18),
('finance', 'fin.monthlyClosing', '{"ja":"月次締め","zh":"月结","en":"Monthly Closing"}', '/financial/monthly-closing', ARRAY['period:manage'], 19),
('finance', 'fin.cashFlow', '{"ja":"資金繰り","zh":"资金周转","en":"Cash Flow"}', '/finance/cash-flow', ARRAY['voucher:read'], 20),
('finance', 'fin.expenseClaims', '{"ja":"経費精算一覧","zh":"经费报销一览","en":"Expense Claims"}', '/finance/expense-claims', ARRAY['voucher:read'], 21),
