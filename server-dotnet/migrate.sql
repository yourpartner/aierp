...
-- 修复 JP01 公司的 row_sequence（根据 CSV 原始顺序）
-- 只在需要修复时执行（检查是否有 row_sequence=0 或 NULL 的记录）
DO $$
DECLARE
    needs_fix BOOLEAN;
    csv_data TEXT[] := ARRAY[
        '2026-01-14|662573||振込 ドイツギンコウ','2026-01-13|525536||振込 TRAVEL PARTNER',
        '2026-01-09||-145|振込手数料','2026-01-09||-15120|振込 ハシモト','2026-01-09||-145|振込手数料',
        '2026-01-09||-39875|振込 ヤマナカ','2026-01-09||-145|振込手数料','2026-01-09||-298084|振込 ボウワルガハ',
        '2026-01-09||-145|振込手数料','2026-01-09||-193602|振込 ホウ ガクエン','2026-01-09||-145|振込手数料',
        '2026-01-09||-241054|振込 カク ナン','2026-01-07|963654||振込 ドイツギンコウ',
        '2026-01-06|878306||フリコミ TRIP COM','2026-01-06|85999||振込 ドイツギンコウ',
        '2026-01-01||-145|振込手数料','2026-01-01||-500000|振込 ホウ ガクエン','2026-01-01|1542||決算お利息',
        '2025-12-30||-145|振込手数料','2025-12-30||-240000|振込 トガワ','2025-12-29|616037||振込 ペイオニア',
        '2025-12-25||-145|振込手数料','2025-12-25||-35640|振込 タカノネツ','2025-12-25||-145|振込手数料',
        '2025-12-25||-183800|振込 カ)フジカフエ','2025-12-25||-145|振込手数料','2025-12-25||-318890|振込 カ.コバヤシ',
        '2025-12-25||-145|振込手数料','2025-12-25||-24970|振込 フジカンコウ','2025-12-25||-145|振込手数料',
        '2025-12-25||-19800|振込 エンタープライズ','2025-12-25||-145|振込手数料','2025-12-25||-30000|振込 カワグチコユウセン',
        '2025-12-25||-809028|PE シヤカイホケン','2025-12-25|880000||振込 イメガ','2025-12-25|942480||振込 デイーエツクス',
        '2025-12-25||-145|振込手数料','2025-12-25||-31560|振込 ユニフアイア','2025-12-25||-145|振込手数料',
        '2025-12-25||-1100000|振込 ビ インホウ','2025-12-25||-145|振込手数料','2025-12-25||-623596|振込 チヨウ レイレイ',
        '2025-12-25||-145|振込手数料','2025-12-25||-249265|振込 ユウ シヨウリ','2025-12-25||-145|振込手数料',
        '2025-12-25||-166970|振込 シユ セイエン','2025-12-25||-145|振込手数料','2025-12-25||-168590|振込 オウ ダイビン',
        '2025-12-25||-145|振込手数料','2025-12-25||-187759|振込 カ キヨウ','2025-12-25||-145|振込手数料',
        '2025-12-25||-186059|振込 リー ボンイン','2025-12-25||-145|振込手数料','2025-12-25||-204765|振込 シン ユ',
        '2025-12-25||-145|振込手数料','2025-12-25||-253330|振込 カク テイテイ','2025-12-25||-145|振込手数料',
        '2025-12-25||-166370|振込 カ ハクセキ','2025-12-23|459154||振込 ドイツギンコウ',
        '2025-12-22||-269500|NSSゼイムコモン','2025-12-18||-145|振込手数料','2025-12-18||-55285|振込 エクスペデイア',
        '2025-12-16|186143||振込 ドイツギンコウ','2025-12-15|1155000||振込 ベース','2025-12-11|456259||振込 TRAVEL PARTNER',
        '2025-12-10||-145|振込手数料','2025-12-10||-6578|振込 カ)ユウセン','2025-12-10||-145|振込手数料',
        '2025-12-10||-265724|振込 ボウワルガハ','2025-12-10||-145|振込手数料','2025-12-10||-43000|振込 カ)エポスカード',
        '2025-12-10||-145|振込手数料','2025-12-10||-183429|振込 ユン カン','2025-12-10||-145|振込手数料',
        '2025-12-10||-75000|振込 ハシモト','2025-12-10||-145|振込手数料','2025-12-10||-71775|振込 ヤマナカ',
        '2025-12-10||-145|振込手数料','2025-12-10||-133982|振込 ホウ ガクエン','2025-12-10||-145|振込手数料',
        '2025-12-10||-212204|振込 カク ナン','2025-12-09|5720000||振込 カ) アミストロング',
        '2025-12-09|449701||振込 ドイツギンコウ','2025-12-04|657051||フリコミ TRIP COM',
        '2025-12-02|1139780||振込 ドイツギンコウ','2025-12-01|756085||振込 TRAVEL PARTNER','2025-12-01|2772||決算お利息',
        '2025-11-28||-145|振込手数料','2025-11-28||-21500000|振込 カ)アイテーバンク','2025-11-28|880000||振込 タカイジヤパン',
        '2025-11-28|3047000||振込 カ)アールテイーエス','2025-11-27||-809028|PE シヤカイホケン',
        '2025-11-26||-145|振込手数料','2025-11-26||-120700|振込 カ)フジカフエ','2025-11-26||-145|振込手数料',
        '2025-11-26||-19800|振込 エンタープライズ','2025-11-26||-145|振込手数料','2025-11-26||-372625|振込 カ.コバヤシ',
        '2025-11-26||-145|振込手数料','2025-11-26||-12650|振込 フジカンコウ','2025-11-26||-145|振込手数料',
        '2025-11-26||-6578|振込 カ)ユウセン','2025-11-26||-145|振込手数料','2025-11-26||-17380|振込 カ) ラクーン',
        '2025-11-26|635392||振込 ドイツギンコウ','2025-11-25||-145|振込手数料','2025-11-25||-249265|振込 ユウ シヨウリ',
        '2025-11-25||-145|振込手数料','2025-11-25||-166970|振込 シユ セイエン','2025-11-25||-145|振込手数料',
        '2025-11-25||-166970|振込 オウ ダイビン','2025-11-25||-145|振込手数料','2025-11-25||-183429|振込 カ キヨウ',
        '2025-11-25||-145|振込手数料','2025-11-25||-186059|振込 リー ボンイン','2025-11-25|1197778||振込 イメガ',
        '2025-11-25||-145|振込手数料','2025-11-25||-586545|振込 チヨウ レイレイ','2025-11-25||-145|振込手数料',
        '2025-11-25||-678600|振込 リユウ シユンホウ','2025-11-25||-145|振込手数料','2025-11-25||-1100000|振込 ビ インホウ',
        '2025-11-25||-145|振込手数料','2025-11-25||-33000|振込 ユニフアイア','2025-11-25||-145|振込手数料',
        '2025-11-25||-204765|振込 シン ユ','2025-11-25||-145|振込手数料','2025-11-25||-253330|振込 カク テイテイ',
        '2025-11-25||-145|振込手数料','2025-11-25||-166370|振込 カ ハクセキ','2025-11-25|775160||振込 デイーエツクス',
        '2025-11-25|24735||振込 ラクテンステイ','2025-11-25||-5500|NSSゼイムコモン','2025-11-20||-145|振込手数料',
        '2025-11-20||-60596|振込 エクスペデイア','2025-11-20|1250818||フリコミ TRIP COM','2025-11-19||-145|振込手数料',
        '2025-11-19||-60000|振込 トラエモン','2025-11-18|558298||振込 ペイオニア','2025-11-17|631978||振込 ドイツギンコウ',
        '2025-11-14|1155000||振込 ベース','2025-11-13||-1340|PE ホウムシヨウ','2025-11-12|701571||振込 ドイツギンコウ',
        '2025-11-10||-145|振込手数料','2025-11-10||-500000|振込 カ)アイテイバンク','2025-11-10||-145|振込手数料',
        '2025-11-10||-43000|振込 カ)エポスカード','2025-11-10|881227||振込 TRAVEL PARTNER','2025-11-10||-145|振込手数料',
        '2025-11-10||-275324|振込 ボウワルガハ','2025-11-10||-145|振込手数料','2025-11-10||-183429|振込 ユン カン',
        '2025-11-10||-145|振込手数料','2025-11-10||-89310|振込 ハシモト','2025-11-10||-145|振込手数料',
        '2025-11-10||-20075|振込 ヤマナカ','2025-11-10||-145|振込手数料','2025-11-10||-133982|振込 ホウ ガクエン',
        '2025-11-10||-145|振込手数料','2025-11-10||-212204|振込 カク ナン','2025-11-06|618375||フリコミ TRIP COM',
        '2025-11-05||-145|振込手数料','2025-11-05||-248872|振込 トラエモン','2025-11-05||-145|振込手数料',
        '2025-11-05||-559023|振込 チヨウ レイレイ','2025-11-05|465656||振込 ドイツギンコウ','2025-11-04|550800||振込 ペイオニア'
    ];
    line TEXT; parts TEXT[]; v_date DATE; v_deposit DECIMAL; v_withdrawal DECIMAL; v_desc_prefix TEXT;
    v_current_date DATE := NULL; v_seq INT := 0; v_id UUID; v_updated INT := 0;
BEGIN
    -- 检查是否需要修复
    SELECT EXISTS(
        SELECT 1 FROM moneytree_transactions 
        WHERE company_code = 'JP01' AND (row_sequence IS NULL OR row_sequence = 0) LIMIT 1
    ) INTO needs_fix;
    
    IF NOT needs_fix THEN
        RAISE NOTICE '[migrate] JP01 row_sequence already fixed, skipping';
        RETURN;
    END IF;
    
    RAISE NOTICE '[migrate] Fixing JP01 row_sequence from CSV data...';
    
    FOREACH line IN ARRAY csv_data LOOP
        parts := string_to_array(line, '|');
        v_date := parts[1]::DATE;
        v_deposit := NULLIF(parts[2], '')::DECIMAL;
        v_withdrawal := NULLIF(parts[3], '')::DECIMAL;
        v_desc_prefix := parts[4];
        
        IF v_current_date IS NULL OR v_current_date <> v_date THEN
            v_current_date := v_date; v_seq := 1;
        ELSE
            v_seq := v_seq + 1;
        END IF;
        
        SELECT id INTO v_id FROM moneytree_transactions
        WHERE company_code = 'JP01' AND transaction_date = v_date
          AND (v_deposit IS NULL OR deposit_amount = v_deposit)
          AND (v_withdrawal IS NULL OR withdrawal_amount = v_withdrawal)
          AND description LIKE (v_desc_prefix || '%')
          AND (row_sequence IS NULL OR row_sequence = 0)
        ORDER BY imported_at ASC LIMIT 1;
        
        IF v_id IS NOT NULL THEN
            UPDATE moneytree_transactions SET row_sequence = v_seq, updated_at = now() WHERE id = v_id;
            v_updated := v_updated + 1;
        END IF;
    END LOOP;
    
    RAISE NOTICE '[migrate] JP01 row_sequence fixed: % records updated', v_updated;
EXCEPTION WHEN OTHERS THEN
    RAISE NOTICE '[migrate] JP01 row_sequence fix skipped: %', SQLERRM;
END $$;
...
FROM (
 ...
 '{"type":"object","properties":{"header":{"type":"object","properties":{"companyCode":{"type":"string"},"postingDate":{"type":"string","format":"date"},"voucherType":{"type":"string","enum":["GL","AP","AR","AA","SA","IN","OT"]},"voucherNo":{"type":"string"},"summary":{"type":"string"},"currency":{"type":"string","enum":["JPY","USD","CNY"]}},"required":["companyCode","postingDate","voucherType","currency"]},"lines":{"type":"array","minItems":1,"items":{"type":"object","properties":{"lineNo":{"type":"integer"},"accountCode":{"type":"string"},"drcr":{"type":"string","enum":["DR","CR"]},"amount":{"type":"number"},"vendorId":{"type":["string","null"]},"customerId":{"type":["string","null"]},"departmentId":{"type":["string","null"]},"employeeId":{"type":["string","null"]},"paymentDate":{"type":["string","null"],"format":"date"},"note":{"type":["string","null"]},"tax":{"type":["object","null"],"properties":{"rate":{"type":"number"},"amount":{"type":"integer"}}}},"required":["lineNo","accountCode","drcr","amount"]}}},"required":["header","lines"]}',
...
-- 受注/発注明細: 精算単価・控除単価を追加
ALTER TABLE stf_juchuu_detail  ADD COLUMN IF NOT EXISTS settlement_rate NUMERIC;
