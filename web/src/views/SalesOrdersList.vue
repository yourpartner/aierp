  ...
  <div class="page">
    <el-card>
      ...
      <el-table :data="rows" stripe style="width: 100%" v-loading="loading">
        <el-table-column prop="so_no" :label="tableLabels.number" width="180" />
        <el-table-column prop="partner_code" :label="tableLabels.customer" width="180" />
        <el-table-column prop="amount_total" :label="tableLabels.amount" width="140" />
        <el-table-column prop="order_date" :label="tableLabels.issueDate" width="160" />
